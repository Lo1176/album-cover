...
import { findArtistRoleById } from './functions/findRoleByArtistId';
import {
...
function App() {
  ...
  // const searchUrl = `https://api.discogs.com/database/search?q=${artistName}&token=${discogsToken}&country=france&format=album&type=release&page=1&per_page=12&sort_by=asc`;
